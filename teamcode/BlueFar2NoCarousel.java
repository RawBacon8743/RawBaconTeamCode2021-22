...
@Autonomous(name="Blue Far 2 No Carousel", group="chad")

public class BlueFar2NoCarousel extends LinearOpMode {

    /* This code is for the blue alliance in the starting position nearest the warehouse
Bot drives forward, strafes right to be centered with the alliance shipping hub, and drives forward and deposits a block in the alliance shipping hub.
Then the bot will back up to the wall, and strafe left, into the warehouse. Finally, it will drive forward a square (maybe strafe left after driving forward?) and park.
...
Gyro functions by a always positive degree amount, and positive direction for clockwise and negative for counter clockwise */
    ...
    //still adjusting values for tightened wheels
    //28 * 20 / (2ppi * 4.125)
