...
public class OpenCVExample extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        waitForStart();
//saves position of capstone maybe
        FindPosition.MarkerPosition position = pipeline.getAnalysis();

        while (opModeIsActive())
        {
            telemetry.addData("Analysis", pipeline.getAnalysis());
            telemetry.update();
           //calls upon saved position maybe?????
            if(position == FindPosition.MarkerPosition.LEFT){
                //Theoretically working, add code here
            }
