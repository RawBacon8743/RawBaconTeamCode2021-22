...
@Autonomous(name="Blue Close REAL", group="chad")

public class BlueCloseREAL extends LinearOpMode {

    /* This code is for the blue alliance in the starting position nearest the carousel
...
Strafing and Driving function like an XY graph for positives and negatives */
    ...
    public void runOpMode(){
       ...
       // DS.setPosition(0);
        ...
        turnWithGyro(-45, 0.6); //speed value greater than 0
       ...
       /* do {
        ...
        } while (sensorRange.getDistance(DistanceUnit.MM) == 20); */
        ...
        moveToPosition(-17, 0.6);

        sleep(50);

        //strafeToPosition(31, 0.6);
